...
AudioConnection          patchCord12(mixer_mic_Sd, biquad_micSpk_EQ);
AudioConnection          patchCord13(filter_HighPass_Amb, 0, mixer_allToSpk, 1);
AudioConnection          patchCord14(biquad_micSpk_EQ, queue_recMic);
AudioConnection          patchCord15(biquad_micSpk_EQ, 0, mixer_allToSpk, 0);
...
void SetupAudioBoard()
{
  ...
  filter_HighPass_Amb.frequency( 500 );
